 <!-- ── ORVOSI ── -->
    <section id="orvosi" class="calc-section py-5 d-none">
        <div class="container">
            <div class="row g-5 align-items-start">
                <div class="col-lg-5 calc-sticky">
                    <div class="cat-card--blue" id="medical-row">
                        <div class="cat-header--blue">Orvosi alkalmasság</div>
                        <div class="p-4">
                            <div class="d-flex justify-content-between">
                                <span class="cat-question mb-0" style="font-size:1rem;">Alkalmassági vizsgálat díja (fix)</span>
